...
function edtp()
 {
  ...
  $.ajax({
    ...
    'url':"<?php echo base_url();?>"+"index.php/mycontroller/changesub",
    'datatype':"JSON",
    'data':{name:ss},
...
function pedit(nm)
{
  ...
  $.ajax({
    ...
    'type':"POST",
    'url':"<?php echo base_url();?>"+"index.php/mycontroller/pkproduct",
    'datatype':"JSON",
    'data':{name:nm},
    'success':function(data){
     // alert(data);
...
function dltpro(dlt)
{
  ...
  $.ajax({
   'type':"POST",
   'url':" <?php echo base_url();?>"+"index.php/mycontroller/deleteprop",
   'data':{name:dlt},
   'success':function(data){
